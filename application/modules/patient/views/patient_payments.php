                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo 'Alias|Company Name';//lang('name'); ?></th>
            ...
            <div class="modal-body row">
                <form role="form" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-5">
                        <label for="name"><?php echo 'Company|Alias';//lang('name'); ?></label>
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" value='' placeholder="">
                    </div>                    
					<div class="form-group col-md-5">
                        <label for="firstname"><?php echo lang('first_name'); ?></label>
                        <input type="text" class="form-control" name="name" id="firstname" value='' placeholder="">
                    </div>                    
					<div class="form-group col-md-5">
                        <label for="lastname"><?php echo lang('last_name'); ?></label>
                        <input type="text" class="form-control" name="name" id="lastname" value='' placeholder="">
                    </div>
