                                ...
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="patient/addNew" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kin_name" id="kin_name" value='<?php
                                            if (!empty($patient->e_contact)) {
                                                echo $patient->e_contact;
                                            }
                                            ?>' placeholder="">
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kin_relations" id="kin_relations" value='<?php
                                            if (!empty($patient->e_contact_relation)) {
                                                echo $patient->e_contact_relation;
                                            }
                                            ?>' placeholder="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kin_phone" id="kin_phone" value='<?php
                                            if (!empty($patient->e_contact_phone)) {
                                                echo $patient->e_contact_phone;
                                            }
                                            ?>' placeholder="">
                                        </div>										
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kin_email" id="kin_email" value='<?php
                                            if (!empty($patient->e_contact_email)) {
                                                echo $patient->e_contact_email;
                                            }
                                            ?>' placeholder="">
                                        </div>
