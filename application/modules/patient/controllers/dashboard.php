                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Receptionist'))) { ?>
                            <li> <li class="sub-menu">
                                <a href="javascript:;" >
                                    ...
                                    <span><?php echo "Doctor Schedule";//lang('schedule'); ?></span>
                                </a>
                                <ul class="sub"> 
                        ...
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a  href="finance/addPaymentView"><i class="fa fa-plus-circle"></i><?php echo "Collect Payment"; //lang('add_payment'); ?></a></li>
