                    ...
                    <div class="clearfix row">
                        ...
                        <form role="form" action="settings/update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <label for=""><?php echo 'Receipt Footer';//lang('discount_type'); ?></label>
								<textarea class="form-control rounded-0" id="exampleFormControlTextarea1" name="receipt_footer" rows="10" cols="50"><?php
                                if (!empty($settings->receipt_footer)) {
                                    echo $settings->receipt_footer;
                                } ?></textarea>
								
								
								<!--<input type="text" class="form-control" name="receipt_footer" id="receipt_footer" value='<?php
                                if (!empty($settings->receipt_footer)) {
                                    echo $settings->receipt_footer;
                                }
