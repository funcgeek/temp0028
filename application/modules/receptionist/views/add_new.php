                                ...
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="receptionist/addNew" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alias_name" id="exampleInputAlias" value='<?php
                                            if (!empty($setval)) {
                                                echo set_value('alias_name');
                                            }
                                            if (!empty($receptionist->alias_name)) {
                                                echo $receptionist->alias_name;
                                            }
                                            ?>' placeholder="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="birthdate" id="exampleInputBirthdate" value='<?php
                                            if (!empty($setval)) {
                                                echo set_value('birthdate');
                                            }
                                            if (!empty($receptionist->birthdate)) {
                                                echo $receptionist->birthdate;
                                            }
                                            ?>' placeholder="">
                                        </div> 
										<div class="form-group">
