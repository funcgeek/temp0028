                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($receptionists as $receptionist) { ?>
                            <tr class="">
                                ...
                                <td> <?php echo $receptionist->alias_name; ?></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="clearfix" action="receptionist/addNew" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                        <label for="exampleInputAlias"> Alias<?php echo lang('name'); ?></label>
                        <input type="text" class="form-control" name="alias_name" id="exampleInputAlias" value=''>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="birthdate" id="exampleInputBirthdate" value='' placeholder="">
                    </div>
					<div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editReceptionistForm" class="clearfix" action="receptionist/addNew" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                        <label for="exampleInputEmail1"> Alias <?php echo lang('name'); ?></label>
                        <input type="text" class="form-control" name="alias_name" id="exampleInputAlias" value='' placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('email'); ?></label>
                        <input type="text" class="form-control" name="email" id="exampleInputEmail1" value='' placeholder="">
					...
					<div class="form-group">
                        <label for="exampleInputBirthdate">Birthdate</label>
                        <input type="text" class="form-control" name="birthdate" id="exampleInputBirthdate" value='' placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('image'); ?></label>
                        <input type="file" name="img_url">
                                        ...
                                        $(document).ready(function () {
                                            $(".editbutton").click(function (e) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    $('#editReceptionistForm').find('[name="alias_name"]').val(response.receptionist.alias_name).end()
                                                    ...
                                                    $('#editReceptionistForm').find('[name="birthdate"]').val(response.receptionist.birthdate).end()
