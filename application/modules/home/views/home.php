                    ...
                    <div class="adv-table editable-table ">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-samplee">
                            ...
                            foreach ($appointments as $appointment) {
                                if ($appointment->date == strtotime(date('d-m-Y'))) {
                                    ?>
                                    <tr class="">
                ...
                <div class="clearfix">
                    ...
                    <?php } ?>
                     ...
                     <?php //echo $this->db->count_all('medicine'); 
										$qt0 = 0;
                                        $this->db->where('quantity >=', $qt0);
                                        $query0 = $this->db->get('medicine');
                                        $query1 = $query0->result();
                                        foreach ($query1 as $qty) {
                                            $medicine_number11[] = '1';
                                        }
                                        //if (!empty($medicine_number1)) {
                                            echo $medicine_number11 = array_sum($medicine_number11);
                                        //} else {
                                        //    $medicine_number1 = 0;
                                       ...
                                       // }
                                        ?>
                                                        ...
                                                        <p>Mobay <br> <?php echo lang('medicine'); ?><br>Available</p>
                                                    </div>
                                                </section>
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                                                                                                                                                                                                </a>
                    <?php } ?>
                          ...
                          <!-- end mobay glass frames -->              
                          <!-- start falmouth  glass frames -->              
                                        <div class="col-lg-4 col-sm-12">
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                                                                                                                                                                                                <a href="medicine">
                    <?php } ?>
                    ...
                    <?php //echo $this->db->count_all('medicine'); 
                                        ...
                                        //if (!empty($medicine_number1)) {
                                            @$medicine_number1 = array_sum($medicine_number1);
											echo $medicine_number1 ;
                                        //} else {
                                        //    $medicine_number1 = 0;
                                        //    echo $medicine_number1;
                                       // }
                                        ?>
                                                        ...
                                                        <p>Falmouth <br> <?php echo lang('medicine'); ?><br>Available</p>
                                                    </div>
                                                </section>
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                                                                                                                                                                                                </a>
