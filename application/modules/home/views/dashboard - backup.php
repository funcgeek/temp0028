...
<!-- START OF POINT OF SALE HIDDEN -- >
 ...
 <!-- END OF POINT OF SALE HIDDEN -->                       
                            ...
                            <li id="header_notification_bar" class="dropdown">
                                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    ...
                                    <span class="badge bg-success">                          
                                        <?php
										$qt = 2;
                                        $this->db->where('quantity <=', $qt);
                                        $query = $this->db->get('medicine');
                                        $query = $query->result();
                                        foreach ($query as $qty) {
                                            $medicine_number1[] = '1';
                                        }
                                        if (!empty($medicine_number1)) {
                                            echo $medicine_number1 = array_sum($medicine_number1);
                                        } else {
                                            $medicine_number1 = 0;
                                ...
                                <ul class="dropdown-menu extended notification">
                                    ...
                                    <li><font color="red"><b>
                                        <p class="yellow"><?php
                                            echo $medicine_number1 . ' ';
                                            if ($medicine_number1 <= 1) {
                                                echo 'Mobay Frame Below 1 QTY ';//lang('medicine_registerred_today');
                                            } else {
                                                echo 'Mobay Frames Below 2 QTY ';//lang('medicine_registerred_today');
                                            }
                                            ?> </p>
                                    </font></b></li>
                                    <li>
                        ...
                        <!-- Falmouth Glass Frame low stock-->
                        <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist', 'Doctor','Receptionist','Nurse'))) { ?> 
                            <li id="header_notification_bar" class="dropdown">
                                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    <i class="fas fa-vial"></i>
                                    <span class="badge bg-success">                          
                                        <?php
										$qt1 = 2;
                                        $this->db->where('quantity_2 <=', $qt1);
                                        $query1 = $this->db->get('medicine');
                                        $query2 = $query1->result();
                                        foreach ($query2 as $qty1) {
                                            $medicine_number2[] = '1';
                                        }
                                        if (!empty($medicine_number2)) {
                                            echo $medicine_number2 = array_sum($medicine_number2);
                                        } else {
                                            $medicine_number2 = 0;
                                ...
                                <ul class="dropdown-menu extended notification">
                                    ...
                                    <li><font color="red"><b>
                                        <p class="yellow"><?php
                                            echo $medicine_number2 . ' ';
                                            if ($medicine_number2 <=1) {
                                                echo 'Falmouth Frames Below 1 QTY ';//lang('medicine_registerred_today');
                                            } else {
                                                echo 'Falmouth Frames Below 2 QTY ';//lang('medicine_registerred_today');
                                            }
                                            ?> </p>
                                    </font></b></li>
                                    <li>
...
<!-- END OF POINT OF SALE HIDDEN -->
					 ...
					 <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Receptionist','Doctor'))) { ?>
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a  href="medicine"><i class="fa fa-medkit"></i><?php echo 'All Frames|Services'; ?></a></li>
                                    <li><a  href="medicine/frameList"><i class="fa fa-medkit"></i><?php  echo 'Frames List'; ?></a></li>
                                    <li><a  href="medicine/serviceList"><i class="fa fa-medkit"></i><?php echo 'Services List'; ?></a></li>
                                    ...
                                    <li><a  href="medicine/addFrameTypeView"><i class="fa fa-plus-circle"></i><?php echo 'Frame Type Category'; ?></a></li>                    <li><a  href="medicine/addFrameTypeItemsView"><i class="fa fa-plus-circle"></i><?php echo 'Frame Category Items'; ?></a></li>
                                </ul>
                            </li>
							<li class="sub-menu">
                                <a href="javascript:;" >
 ...
 <!-- END OF FRAME SALE HIDDEN -->                                   
                             <li class="sub-menu">
                                <a href="javascript:;" >
                                    <i class="fa fa-medkit"></i>
                                    <span><?php echo 'Frame Expenses';//lang('medicine'); ?></span>
                                </a>
                                <ul class="sub">       	
									<li><a  href="finance/pharmacy/expense"><i class="fa fa-money-check"></i><?php echo 'Frame Expenses'; ?></a></li>
                        ...
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
                            <li class="sub-menu">
                                <a href="javascript:;" >
                                    <i class="fa fa-users"></i>
                                    <span><?php echo 'Staff Management';//lang('human_resources'); ?></span>
                                </a>
                                <ul class="sub">
						...
						<?php if ($this->ion_auth->in_group(array('admin','Doctor'))) {  ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
									...
									<li><a  href="analytics/monthlySales"><i class="fa fa-robot"></i><?php echo lang('analytics_monthly_sales'); ?></a></li>
