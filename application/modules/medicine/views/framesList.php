    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            <header class="panel-heading">
                <?php echo lang('medicine'); ?> <?php
					$query_mb = $this->db->query("SELECT quantity FROM medicine where type = 'frames'");
					$query_fm = $this->db->query("SELECT quantity_2 FROM medicine where type = 'frames'");
					echo "(<font color='red'>";
					echo $query_mb->num_rows();
					echo "</font>)" ;					
/*					
					echo "(<font color='green'>";
					echo $query_fm->num_rows();
					echo "</font>)" ;
*/
?>
