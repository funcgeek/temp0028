        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <div class="col-md-4 no-print pull-right"> 
                    <a data-toggle="modal" href="#myModalPercentage">
                        <div class="btn-group pull-right">
                            <button id="" class="btn btn-primary btn-xs">
                                <i class="fa fa-plus-circle"></i> Update by %%
                            </button>
                        </div>
                    </a> &nbsp;&nbsp;&nbsp;
					<a data-toggle="modal" href="#myModalPrice">
                        <div class="btn-group pull-right">
                            <button id="" class="btn btn-info btn-xs">
                                <i class="fa fa-plus-circle"></i> Update by $$
                            </button>
                        </div>
                    </a>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th> <?php echo 'Location';//lang('category'); ?></th>
                        ...
                        foreach ($medicines as $medicine) {
                            ...
                            <tr class="">
                                ...
                                <td> <?php echo $medicine->location; ?></td>
...
<div class="modal fade" id="myModalPercentage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">Update all Prices by Percentage</h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editMedicineForm" class="clearfix" action="medicine/updatePrices" method="post" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="exampleInputEmail1"> Enter % Value</label>
                        <input type="text" class="form-control" name="qty_percentage" id="exampleInputEmail1" value='' placeholder="">
                    </div>
...
<div class="modal fade" id="myModalPrice" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> Update all Prices by Dollar Value</h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editMedicineForm" class="clearfix" action="medicine/updatePrices" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Enter $ Value</label>
                        <input type="text" class="form-control" name="qty_value" id="exampleInputEmail1" value='' placeholder="">
                    </div>
