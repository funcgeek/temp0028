    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel-body col-md-12">
            ...
            <div class="row">
                ...
                <form role="form" action="medicine/addNewFrameType" class="clearfix" method="post" enctype="multipart/form-data">
                   <div class="row">
                     <div class="col-md-3">
					
                        <label for="exampleInputCategory"> <?php echo 'Category Name'; ?></label><br>
                        <input type="text" name="name"  value='' placeholder="" required="">
					</div>
				
					<div class="col-md-9">			
                        <label for="exampleInputDescription"> <?php echo 'Description'; ?></label><br>
                      <input type="text" class="" size="90" name="description" value='' placeholder="">
							   ...
							   <?php foreach ($categories as $category) { ?>
                     						 ...
                     						 <?php //if (!$this->ion_auth->in_group(array('Patient'))) { ?>			
													...
													<!--	<button type="button" class="btn btn-info btn-xs btn_width editbutton no-print" data-toggle="modal" <!-- data-target="#myModal2"  data-id="<?php echo $category->id; ?>"><i class="fa fa-edit"> </i>Edit</button>                 								
														...
														<a href="#editbutton" class="btn btn-default btn- editbutton id="editbutton" data-toggle="modal" data-id="<?php echo $category->id; ?>" >Edit</a></td>
        ...
        <div class="modal-content">
			...
			<table class="table table-striped table-hover table-bordered" id="editable-sample1">
             <!--   <form role="form" id="editCategoryForm" action="medicine/addNewCategory" class="clearfix" method="post" enctype="multipart/form-data">
                ...
                <form role="form" id="editCategoryForm" action="medicine/addNewFrameType" class="clearfix" method="post" enctype="multipart/form-data">
                   <div class="row">
                     <div class="col-md-3">
...
<script type="text/javascript">
                                    $(document).ready(function(){
									    $('.editbutton').on('show.bs.modal', function (e) {
                                            ...
                                            $('#myModal').modal('show');
                                            $.ajax({
                                                url: 'medicine/editFrameTypeByJason?id=' + iid,
                                                method: 'GET',
                                                data: '',
                                                dataType: 'json',
                                                ...
                                                $('#editCategoryForm').find('[name="category"]').val(response.frametype.category).end()
                                                $('#editCategoryForm').find('[name="description"]').val(response.frametype.description).end()
                                            });
                                        });
                                    });
</script>									
