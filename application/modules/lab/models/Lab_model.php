...
//the database information for the lab dashboard

    function getFrameRegistration() {
        $this->db->order_by('id', 'desc');
        $query = $this->db->get('lab_frame_registration');
        return $query->result();
    }  
   
   function getFrameItems() {
        $this->db->order_by('id', 'desc');
        $query = $this->db->get('lab_inv_frame_items');
        return $query->result();
    }  
    
	function getFrameTypes() {
        $this->db->order_by('id', 'desc');
        $query = $this->db->get('lab_inv_frame_type');
        return $query->result();
    }      
	
	function getFrameProcessing() {
        $this->db->order_by('id', 'desc');
        $query = $this->db->get('lab_frame_processing');
        return $query->result();
    }  
	
	function getReportLog() {
        $this->db->order_by('id', 'desc');
        $query = $this->db->get('lab_report_log');
        return $query->result();
    }  
