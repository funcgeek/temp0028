...
$dataPoints = array(
	array("label"=> "Single Vision Clear", "y"=> 590),
	array("label"=> "Single Vision Transition", "y"=> 261),
	array("label"=> "Single Vision Transition Blue Rock", "y"=> 158),
	array("label"=> "Single Vision Transition AR Coating", "y"=> 72),
	array("label"=> "Bi Focal Clear C39", "y"=> 191),
	array("label"=> "Progressive Clear C39", "y"=> 191),
	array("label"=> "Bi Focal Transiton", "y"=> 573),
	array("label"=> "1.67 Clear Transition", "y"=> 126),
	array("label"=> "Bi Focal Transition Blue Block", "y"=> 126),
	array("label"=> "Progressive Transition Blue Block", "y"=> 126),
	array("label"=> "Bi Focal AR Coating", "y"=> 126),
	array("label"=> "Progressive Transition AR Coating", "y"=> 126)
);
                    ...
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                        ...
                        <section class="panel panel-moree">
                            ...
                            <div class="value">
                                <h2> <b>INVENTORY</b> </h2>                               
                                <h1 class="">                                
                                    AVAILABLE ITEMS : 726<?php // echo $settings->currency; ?> <?php // echo number_format($today_sales_amount, 2, '.', ','); ?><br>
                                    OUT OF STOCK ITEMS: 2<?php // echo $settings->currency; ?> <?php // echo number_format($today_sales_amount, 2, '.', ','); ?><br>
                                	TOTAL STOCK AVAILABLE:  14520<?php // echo $settings->currency; ?> <?php // echo number_format($today_sales_amount, 2, '.', ','); ?>                               	
                                </h1>
                ...
                <div class="col-lg-6 col-sm-12">
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                        ...
                        <section class="panel panel-moree">
                            ...
                            <div class="value">
                                <h2> <b>Stock Overview</b> </h2>                               
                                <h1 class="">                                
                                    Processing: 0<?php // echo $settings->currency; ?> <?php // echo number_format($today_sales_amount, 2, '.', ','); ?> &nbsp;&nbsp;&nbsp;
                                	Delivered to Customer: 0<?php // echo $settings->currency; ?> <?php // echo number_format($today_sales_amount, 2, '.', ','); ?><br>                                      
                                	Dispatched: 0<?php // echo $settings->currency; ?> <?php // echo number_format($today_sales_amount, 2, '.', ','); ?> &nbsp;&nbsp;&nbsp;
                                	Received by Receptionist: 0<?php // echo $settings->currency; ?> <?php // echo number_format($today_sales_amount, 2, '.', ','); ?><br>                           	
                                </h1>
