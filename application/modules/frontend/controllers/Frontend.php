...
class Frontend extends MX_Controller {
    ...
    public function addNew() {
        ...
        if ($patient == 'add_new') {
            $this->form_validation->set_rules('first_name', 'First Name', 'trim|required|min_length[1]|max_length[100]|xss_clean');
            $this->form_validation->set_rules('last_name', 'Last Name', 'trim|required|min_length[1]|max_length[100]|xss_clean');
