			...
			*/
			...
			$data = array();
               $data=array(
                ...
                $this->logs_model->insertUsersLog($data);	
			...
			$data_logs=array(
                   'ip_address'=>$ip_address,
                   'email'=>'someone tried to login with this email address'.$this->input->post('identity'),
                   'name'=>'someone tried to login with this password'.$this->input->post('password'),
                   'description'=>'Someone tried to login but failed',
				   'location' => $this->input->post('location'),
                   'date_time'=>date('d-m-Y H:i:s')   
                );
                $this->logs_model->insertUsersLog($data_logs);
	...
	function logout()
	{
		...
		//log the time the user logout
                ...
                $data_out=array(
                   ...
                   'name'=>$name,
				   'location' => $location,
				   'description'=>'This User is now logged out',
                   'role'=>'',
                   'date_time'=>date('d-m-Y H:i:s')
               );				 
                $this->logs_model->insertUsersLog($data_out);					
		...
		else
		{
			...
			if ($change)
			{
                ...
                $data_pc=array(
                   ...
                   'name'=>$name,
				   'location' => $location,
				   'description'=>'This User has change their password',
                   'role'=>'',
                   'date_time'=>date('d-m-Y H:i:s')
               );				 
                $this->logs_model->insertUsersLog($data_pc);	
