...
class Doctor_model extends CI_model {
    ...
    function getDoctorBySearch($search) {
        ...
        $this->db->or_like('lic_number', $search);
        $query = $this->db->get('doctor');
        return $query->result();
    }
 ...
 function getDoctorInfo($searchTerm) {
        if (!empty($searchTerm)) {
            $this->db->select('*');
			$this->db->where("name like '%" . $searchTerm . "%' OR id like '%" . $searchTerm . "%' OR lic_number like '%" . $searchTerm . "%'OR email like '%" . $searchTerm . "%' OR phone like '%" . $searchTerm . "%'");
