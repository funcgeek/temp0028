...
class Doctor extends MX_Controller {
    ...
    public function addNew() {
        ...
        $postnomials = $this->input->post('postnomials');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $last_name1 = $postnomials;
            $first_name1 = $department;
...
// Email that was just posted
//$email = $_POST['email']; // Make sure to sanitize/validate
...
if ($user_id) {
    // Step 2: Insert into users_group
    $stmt2 = $conn->prepare("INSERT INTO users_groups (user_id, group_id) VALUES (?, ?)");
    $group_id = 4;
