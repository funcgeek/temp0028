        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="doctor/addNew" class="clearfix" method="post" enctype="multipart/form-data">
					...
					<div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo 'Post Nominals';//lang('name'); ?></label>
                        <input type="text" class="form-control" name="postnomials"  value='' placeholder="M.D, PgDip, PhD">
                    </div>                    
					<div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo 'Reg/Lic. No.';//lang('name'); ?> </label>
                        <input type="text" class="form-control" name="lic_number"  value='' placeholder="Reg.#11310">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                                <label for="exampleInputEmail1"><?php echo 'Visit Price'; ?> &#42;</label>
                                <input type="text" class="form-control" name="visit_price"  value='' placeholder="" required="">
                    </div>                    
					<div class="form-group col-md-6">
                                <label for="exampleInputEmail1"><?php echo 'Date of Birth'; ?></label>
                    ...
                    -->
                    <!-- changing above to Input Hidden -->
                    <input type="hidden" name="profile" value="OpticalDoctor">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editDoctorForm" class="clearfix" action="doctor/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('name'); ?> &#42;</label>
                        <input type="text" class="form-control" name="name"  value='dd' placeholder="" required="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('email'); ?> &#42;</label>
                        <input type="text" class="form-control" name="email"  value='' placeholder="" required="">
                    ...
                    <div class="form-group col-md-6">
                                <label for="exampleInputEmail1"><?php echo lang('visit_price'); ?> Visit Price</label>
                                <input type="text" class="form-control" name="visit_price"  value='' placeholder="" required="">
                            </div>
                                   <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Licence Number</label>
                                <input type="text" class="form-control" name="lic_number"  value='' placeholder="" required="">
                            </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('department'); ?></label>
                ...
                <form role="form" id="editDoctorForm1" class="clearfix" action="doctor/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="profileClass"></div>
                             ...
                             <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Licence Number</label>
                        <div class="lic_numberClass"></div>
                    </div>
                             <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Visit Price</label>
                        <div class="visit_priceClass"></div>
                    </div>
    ...
    $(document).ready(function () {
        $(".table").on("click", ".editbutton", function () {
            ...
            $.ajax({
                ...
                $('#editDoctorForm').find('[name="lic_number"]').val(response.doctor.lic_number).end()
                $('#editDoctorForm').find('[name="visit_price"]').val(response.doctor.visit_price).end()
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".table").on("click", ".inffo", function () {
            ...
            $('.visit_priceClass').html("").end()
            $('.lic_numberClass').html("").end()
            $.ajax({
                url: 'doctor/editDoctorByJason?id=' + iid,
                method: 'GET',
                data: '',
                ...
                $('.visit_priceClass').append(response.doctor.visit_price).end()
                $('.lic_numberClass').append(response.doctor.lic_number).end()
