    ...
    <section class="wrapper site-min-height">
        <section class="col-md-6">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    <blockquote>
                        <a href="files/downloads/patient_xl_format.csv"><?php echo lang('download'); ?></a> <?php echo lang('the_format_of_xl_file'); ?>.
                        <br> <?php echo lang('please_follow_the_exact_format'); ?>. 
                        <br> Right-click on download and click on SAVE LINK AS. 
                    </blockquote>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                      ...
                      <!--  <form role="form" action="<?php echo site_url('import/importPatient') ?>" class="clearfix" method="post" enctype="multipart/form-data"> -->
                        <form role="form" action="/db/csvimport.php" class="clearfix" method="post" enctype="multipart/form-data"> 
                            <div class="box-body">
                                <div class="form-group has-feedback">
                                    <label for="exampleInputEmail1"> <?php echo lang('choose_file'); ?> &#42;</label>
                                    <input type="file" class="form-control" placeholder="" name="filename" required accept=".csv">
                                    <span class="glyphicon glyphicon-file form-control-feedback"></span>
                                    <input type="hidden" name="tablename"value="patient">
                                    <input type="hidden" name="user"value="<?php echo $this->ion_auth->get_user_id();?>">
                                </div>
