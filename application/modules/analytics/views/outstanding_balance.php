    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                Outstanding Balance owed by Patients
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($payments as $payment) { ?>
                            ...
                            <tr class="">
                                ...
                                <td><?php echo $payment->patient_first_name; ?></td>                                
                                <td><?php echo $payment->patient_last_name; ?></td>                                
                                <td>$<?php echo $payment->amount; ?></td>                                
                                <td>$<?php echo $payment->discount; ?></td>                                
                                <td>$<?php echo $payment->gross_total; ?></td>                                
                                <td>$<?php echo $payment->amount_received; ?></td>              
                                <td><font color="red"><b>$<?php echo $payment->balance; ?></b></font></td>              
