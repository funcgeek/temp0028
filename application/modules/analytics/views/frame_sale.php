    ...
    <section class="wrapper site-min-height">           
        ...
        <div class="col-md-12">
            <header class="panel-heading">
                <i class="fa fa-home"></i>  Overall Frame Sales <?php echo lang('dashboard'); ?>
            </header>
                ...
                <div class="col-lg-3 col-sm-6">
                    <?php if ($this->ion_auth->in_group(array('admin','Doctor'))) { ?>
                        ...
                        <section class="panel panel-moree">
                            ...
                            <div class="value">
                                <p> <?php echo 'Out of Stock';//lang('staff'); ?> </p>
                                <h1 class="">
                        ...
                        <div class="panel">         
                            ...
                            <table class="table table-striped table-hover table-bordered" id="">
                                ...
                                foreach ($payments as $payment) {
                                    ...
                                    <tr class="">
                                        <td><a href="finance/pharmacy/invoice?id=<?php echo $payment->id; ?>"><?php echo $payment->id; ?></a></td>
...
-->
    ...
    <?php
    // Ask the database to count all records in the 'pharmacy_payment' table.
    echo $this->db->count_all('pharmacy_payment');
    ?>
</span>
                                    </td>
                                    <td>
    ...
    // Loop through all payments without filtering by month
    foreach ($query as $q) {
        $sales_total[] = $q->gross_total;
    }
    ...
    if (!empty($sales_total)) {
        ...
        // Display 0.00 if there are no sales records at all
        echo '0.00';
    }
    ?>
</span>
...
-->
    ...
    <span class="badge bg-info">
        <?php
        // Select the sum of both quantity columns
        $this->db->select_sum('quantity', 'total_q1');
        $this->db->select_sum('quantity_2', 'total_q2');

        // IMPORTANT: Only get rows where the type is 'frames'
        ...
        // Add the two totals together for the final sum
        $total_frames = $result->total_q1 + $result->total_q2;
