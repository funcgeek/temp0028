        ...
        <div class="col-md-12">
            <div class="row state-overview" style="padding: 23px 0px;">
                <div class="col-md-8">
                    ...
                    <div class="panel-heading"> <?php echo date('F, Y', $first_minute) . '  ' .lang('sales_report'); ?> 
                        ...
                        <div class="col-md-1 pull-right no-print">
                            <a href="analytics/dailySale?year=<?php echo $next_year; ?>&month=<?php echo $next_month; ?>">
                                <i class="fa fa-arrow-right"></i>
                            </a>
                        </div>
                        <div class="col-md-1 pull-right no-print">
                            <a href="analytics/dailySale?year=<?php echo $previous_year; ?>&month=<?php echo $previous_month; ?>">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample1">
                                <thead>
                                    <tr>
										...
										<th> <?php echo 'Details';//lang('amount'); ?> </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    for ($d = 1; $d <= $number_of_days; $d++) {
										...
										$daily_sales = date('d-m-y', $time);
                                        ?>
                                        <tr>
                                            <td><?php echo $day; ?></td>
                                            <td><?php echo $this->currency; ?><?php echo number_format($amount, 2, '.', ','); ?></td>
											<td><a class="btn btn-info btn-xs invoicebutton" href="analytics/dailyDetails?id=<?php echo $daily_sales; ?>"><i class="fa fa-file-text"></i> <?php echo lang('details'); ?> </a></td>
