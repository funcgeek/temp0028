...
class Finance_model extends CI_model {
    ...
    function getPaymentByPatientId($id) {
		...
		function getPaymentByLastId($payment_id) {
	...
	function getDepositLastAmountByPaymentId($payment_id) {
        $this->db->select('*');
        $this->db->from('patient_deposit');
        $this->db->where('payment_id', $payment_id);
        $query = $this->db->get();
    ...
    function makeStatusPaid($id, $patient_id, $data, $data1) {
        ...
        $this->db->update('pharmacy_payment', $data);
        $this->db->where('id', $id);
        $this->db->update('pharmacy_payment', $data1);
    }
    ...
    function getThisMonth() {
        $payments = $this->db->get('pharmacy_payment')->result();
    ...
    function getDueBalanceByPatientId($patient) {
        $query = $this->db->get_where('pharmacy_payment', array('patient' => $patient->id))->result();
