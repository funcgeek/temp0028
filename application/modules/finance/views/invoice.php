                    ...
                    <div class="row invoice-list">
                        ...
                        <div class="col-md-12 invoice_head clearfix">
                            ...
                            <div class="col-md-12 text-left invoice_head_left">
                                <h3>
									...
									<img alt="" src="<?php echo $this->settings_model->getSettings()->logo; ?>" width="200" height="60">
                                </h3>
                                <h4>
                        ...
                        <div class="col-md-12">
                                    ...
                                    <p>
                                        ...
                                        <span style="text-transform: uppercase;"> : 
                                            ...
                                            if (!empty($patient_info)) {
                                                echo $patient_info->first_name . '&nbsp;' .$patient_info->last_name . ' <br>';
                                            }
                                            ?>
                                        </span>
                                    </p>
                            ...
                            <div class="col-md-6 pull-right" style="text-align: left;">
                                ...
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <label class="control-label"><?php echo lang('invoice'); ?>  </label><br>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($payment->id)) {
                                                echo $payment->id;
								...
								<div class="col-md-12 row details">
                                    <p>
                                        <label class="control-label"><?php echo 'Cashier';//lang('doctor'); ?>  </label><br>
									: <?php echo $this->ion_auth->user($payment->user)->row()->alias;
										// $this->db->get_where('medicine', array('name' => $name))->row();
									?>
                                    </p>
                                </div>
                    ...
                    <div class="">
                        <div class="col-lg-6 invoice-block pull-right">
                            <ul class="unstyled amounts">
                                <li><strong><?php echo lang('sub_total'); ?> :____ <?php echo $settings->currency; ?> <?php echo $payment->amount; ?></strong></li>
                                ...
                                <?php } ?>
                                <li><strong>
								<?php echo lang('grand_total'); ?> :____ <?php echo $settings->currency; ?> <?php echo $g = $payment->gross_total; ?></strong>
								</li>
                                <li><strong>
								<?php echo lang('amount_received'); ?> :____ <?php echo $settings->currency; ?> <?php echo $r = $this->finance_model->getDepositAmountByPaymentId($payment->id); ?></strong></li>
                                <li><strong>
								<?php 
								$change = $g - $r; 
								
								if ( $change < 0 ) 
								{ echo lang('amount_to_be_paid'); ?> :____ <?php echo $settings->currency; echo $change; }
								if ( $change > 0 )
								{ echo 'change'; ?> :____ <?php echo $settings->currency; echo $change; }			
