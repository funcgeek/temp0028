...
<!-- end frames -->
                                ...
                                <div class="col-md-12 payment right-six">
                                    <div class="payment_label"> 
                                        <label for="exampleInputDiscount"> <?php echo lang('discount'); ?><?php
                                            if ($discount_type == 'percentage') {
                                                echo ' (%)';
                                            }
                                            ?> </label>
                                    ...
                                    <div class=""> 
                                        <input type="number" class="form-control pay_in" name="discount" id="dis_id" min="00" max ="99" maxlength="2" value='<?php
                                        if (!empty($payment->discount)) {
                                            $discount = explode('*', $payment->discount);
                                            echo $discount[0];
                                        }
								...
								<div class="payment_label"> 
									...
									<div id="passw" class="col-md-12 payment right-six">
										<div class="payment_label">
										<label for="exampleInputDiscount">Need More Discount</label>
										</div>
									<div class="">	
									<input type="password" class="form-control pay_in" id="password" onkeydown="if (event.keyCode == 13) document.getElementById('button').click()" /> <!-- IMPORTANT! this part is so if you click enter, it works. -->	
									<a id="button" type="button" class="btn btn-primary mb-2"  onclick="showDiv()" >Verify</a>	
...
if (document.getElementById('password').value == 'PASSWORD') { 
	...
	$('#editPaymentForm').find('[id="dis_id2"]').val('0');
	} 
else {  
alert('Invalid Password!'); 
password.setSelectionRange(0, password.value.length);   
document.getElementById('table2').style.display='BLOCK'; 
$('#editPaymentForm').find('[id="dis_id"]').val('0');
}
}
</script>				
...
<!-- it will autoselect wrong input if wrong -->
								...
								<div class="payment_label"> 
                                        <label for="exampleInputEmail1"> <font color="red">Supervisor Discount</font><?php
                                            if ($discount_type == 'percentage') {
                                                echo ' (%)';
                                            }
                                            ?> </label>
									...
									<?php if (empty($payment->id)) { ?>                 
                                                         <select id="selecttype" name="deposit_type[]" style="width: 100px;" onchange="showcharge()"> 
                                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist','Nurse'))) { ?>
                                                                ...
                                                                <option value="Insurance"> <?php echo 'Insurance Only';//lang('cash'); ?> </option>
                                                    ...
                                                    <div class=""> 
                                                        <select class="form-control m-bot15 js-example-basic-single selecttype" id="selecttype" name="deposit_type" value=''> 
                                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist','Nurse'))) { ?>
                                                                ...
                                                                <option value="Insurance_Only"> <?php echo 'Insurance Only';//lang('cash'); ?> </option>
                                                                <option value="Pay Next Visit"> <?php echo 'Pay Next Visit';//lang('cash'); ?> </option>
                                                                <option value="Card"> <?php echo lang('card'); ?> </option>
                                                                <option value="Other/Balance Due"> <?php echo 'Other | Balance Due';//echo lang('card'); ?> </option>
                                                            <?php } ?>
