        ...
        <div class="col-md-12">
            <div class="row state-overview" style="padding: 23px 0px;">
                <div class="col-md-8">
                    ...
                    <?php
                    $currently_processing_month = date('d', $first_minute);
                    $currently_processing_year = date('d', $last_minute);
                    if ($currently_processing_month <= 7) {
                        $next_month = $currently_processing_month + 6;
                        $next_year = $currently_processing_year;
                    } else {
                        $next_month = 7;
                        $next_year = $currently_processing_year + 7;
                    }

                    if ($currently_processing_month > 6) {
                        $previous_month = $currently_processing_month - 7;
                        $previous_year = $currently_processing_year;
                    } else {
                        $previous_month = 7;
                        $previous_year = $currently_processing_year - 6;
                    }
                    ?>
