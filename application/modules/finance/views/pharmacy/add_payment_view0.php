                    ...
                    <div class="clearfix">
                        ...
                        <form role="form" class="clearfix pos form1"  id="editPaymentForm" action="finance/pharmacy/addPayment" method="post" enctype="multipart/form-data">
                                                ...
                                                <select name="category_name[]"  class="multi-select1"  multiple="multiple" id="my_multi_select4" >
                                                    ...
                                                    if (!empty($payment)) {
                                                        ...
                                                        foreach ($category_name1 as $category_name2) {
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $medicine->id . '*' . (float) $medicine->s_price . '*' . $medicine->name . '*' . $medicine->effects. '*' . $medicine->box; ?>" data-qtity="<?php echo $category_name3[2]; ?>" selected="selected">
                            ...
                            <div class="col-md-4 right-six">
                                ...
                                <div class="col-md-12 payment right-six">
                                    <div class="col-md-3 payment_label"> 
                                        <label for=""> <?php echo lang('discount'); ?><?php
...
<!-- it will autoselect wrong input if wrong -->
	...
	<table id="emptbl" cellspacing='0' cellpadding='0'>
		...
		<tr> 
			...
			<input type="text" size='8' class="form-control collect" style="border: 1;" name="amount_received[]"  id="amount_received" value='<?php
	...
	<table cellspacing='0' cellpadding='0' id="nocharge" class='collect' >
		<tr> 
			<td>
			<font color="green">
...
//	document.getElementById('amount_received').style.display='none'; 
	...
	var divsToHide = document.getElementsByClassName("collect");
    for(var i = 0; i < divsToHide.length; i++)
    {
   // divsToHide[i].style.display='none'; 
	divsToHide[i].setAttribute("readonly", true);
    }
  ...
  //  document.getElementById('amount_received').style.display='block'; 
    ...
    for(var i = 0; i < divsToHide.length; i++)
    {
    divsToHide[i].removeAttribute("readonly");
        ...
        $.each($('select.multi-select1 option:selected'), function () {
            ...
            if ($('#idinput-' + id).length)
            {
                ...
                if ($('#id-div' + id).length)
                {
                    ...
                    $("#editPaymentForm .qfloww").append('<div class="remove1" id="id-div' + id + '"><div class="name pos_element"> Name: ' + res[2] + '</div><div class="effects pos_element">Color: ' + res[3] + '</div><div class="price pos_element">price: ' + res[1] + '</div><div class="current_stock pos_element">Current Stock: ' + res[4] + '</div><div class="quantity pos_element">quantity:<div></div>')
                }
