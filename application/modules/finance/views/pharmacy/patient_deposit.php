            ...
            <div class=" panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <section class="col-md-12 no-print row">
                        <form role="form" class="f_report" action="/finance/pharmacy/patientPaymentHistory" method="post" enctype="multipart/form-data">
                            ...
                            foreach ($payments as $payment) {
                                if ($payment->date == $value) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td><font color="green"> <?php echo $payment->gross_total; ?> </font></td>
                                        ...
                                        <!--    <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                                <a class="btn-xs btn-info" title="<?php echo lang('edit'); ?>" style="width: 25%;" href="finance/pharmacy/editPayment?id=<?php echo $payment->pharmacy_id; ?>"><i class="fa fa-edit"> </i></a>
                                            <?php } ?> -->
                                            <a class="btn-xs invoicebutton" title="<?php echo lang('invoice'); ?>" style="color: #fff; width: 25%;" href="finance/pharmacy/invoice?id=<?php echo $payment->pharmacy_id; ?>"><i class="fa fa-file-invoice"></i> </a>
                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?> 
                                                <a class="btn-xs btn-info delete_button" title="<?php echo lang('delete'); ?>" style="width: 25%;"  href="finance/pharmacy/delete?id=<?php echo $pharmacy_id->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> </a>
                                            <?php } ?>
                                            </button>
                                        </td>
                                    </tr>
                                ...
                                if ($deposit->date == $value) {
                                    if (!empty($deposit->deposited_amount) && empty($deposit->amount_received_id)) {
                                        ...
                                        <tr class="">
                                            ...
                                            <td><font color="green"> <?php echo $payment->gross_total; ?> </font></td>
                                            <td><font color="orange"><?php echo $deposit->deposited_amount; ?></font></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <div class="degree">
                                        ...
                                        $total_deposit = array();
                                        foreach ($deposits as $deposit) {
                                            $total_deposit[] = $deposit->amount_received;
                                        }
