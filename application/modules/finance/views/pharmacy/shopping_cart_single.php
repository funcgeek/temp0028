...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <section class="">
								...
								<div class="col-md-12 payment pad_bot">
                                             <!--   <label for="exampleInputEmail1"><?php /*echo lang('patient'); ?></label>
                                              ...
                                              < !--      <option value="add_new" style="color: #41cac0 !important;"><?php echo lang('add_new'); ?></option>-/- >
                                                ...
                                                <h4>  <?php echo $patient->first_name .'&nbsp;'. $patient->middle_name .'&nbsp;'. $patient->last_name; ?></h4>
        	...
        	<div class="col-md-12 row">
  			 ...
  			 <tr>
  			 	...
  			 	<th><u>Model</u></th>
  			 	<th><u>Color</u></th>
  			 	<th><u><b><font color="red">Frame Price</font></b></u></th>
  			 	<th><u>Lens Type</u></th>
		...
		<!--	<a class="btn btn-info btn-xs btn_width delete_button" href="finance/pharmacy/deletecart?id=<?= $cart->id ?>"><i class="fa fa-trash"> </i></a>-->
                            ...
                            <div class="col-md-4 right-six">
                                <div class="col-md-12 payment right-six">
									...
									<?php foreach($cart_subtotal as $ctotal){ ?>
                                        <input type="text" class="form-control pay_in" name="subtotal" id="subtotal" value='<?=$ctotal->subtotal?>' placeholder=" " readonly="readonly">
										<?php } ?>
                                    </div>
...
<!-- it will autoselect wrong input if wrong -->
	...
	<table id="emptbl" cellspacing='0' cellpadding='0'>
		...
		<tr> 
			...
			<input type="number" required size='8' class="form-control" style="border: 1;" name="amount_received[]"  id="amount_received" value='<?php
            ...
            $(document).ready(function () {
                 ...
                 //   $('#editPaymentForm').find('[name="subtotal"]').val(tot).end()
                    $('#editPaymentForm').find('[name="grsss"]').val(gross)
                     $('#editPaymentForm').find('[name="disc_val"]').val(new_dis)
                });
   ...
   // });
    $(document).ready(function () {
        $('#dis_id').keyup(function () {
            ...
            val_dis = this.value;
         //   
            new_dis = (val_dis / 100) * amount;
            ggggg = amount - new_dis;
