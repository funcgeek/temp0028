...
<section id="main-content">
    <section class="wrapper site-min-height">
  	...
  	<div class="col-md-12 payment_label row"> 
   			 <table class="table table-striped table-hover table-bordered" id="" width="100%">
   			 <form>
  			 <thead>
  			 <tr>
  			 	<th>Model</th>
  			...
  			<tbody>
  			<tr>
  			<td>		 <select id="category_search" class="" name="category_name[]" style="text-align: center;" >
  		...
  		<td>		 <select id="category_search2" class="" name="category_name2[]" style="text-align: center;" >
    		<option value=""></option>
                            <?php foreach ($medicines as $medicine) { ?>
                                <option value="<?php echo $medicine->name; ?>" >
                                	 <?php echo $medicine->name; ?> 
  		...
  		<td>		 <select id="category_search3" class="" name="category_name3[]" style="text-align: center;" >
    		<option value=""></option>
                            <?php foreach ($medicines as $medicine) { ?>
                                <option value="<?php echo $medicine->name; ?>" >
                                	 <?php echo $medicine->name; ?> 
  		...
  		<td>		 <select id="category_search4" class="" name="category_name4[]" style="text-align: center;" >
    		<option value=""></option>
                            <?php foreach ($medicines as $medicine) { ?>
                                <option value="<?php echo $medicine->name; ?>" >
                                	 <?php echo $medicine->name; ?> 
