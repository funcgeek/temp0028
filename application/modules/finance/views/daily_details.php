<?php
$conn = mysqli_connect("localhost", "ispecs", "Pass@2020", "ispecs_0");
    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                  <?php echo 'Daily Sales';//lang('payments'); ?> 
            </header>
            <div class="col-md-12">
                        ...
                        <thead>
                            <tr>
                               ...
                               <th><?php echo lang('date'); ?></th>
                                ...
                                <th><?php echo 'QTY';//lang('date'); ?></th>
                                <th><?php echo 'Service/Items';//lang('date'); ?></th>
                                <th><?php echo 'Price';//lang('total'); ?></th>
                                <th><?php echo 'Payment Type';//lang('total'); ?></th>
                                <th><?php echo 'Amount Received';//lang('total'); ?></th>								
...
//	if (isset($_REQUEST['id'])) {
		...
		$query = "SELECT * FROM payment where date_string = '".$id3."'";
		$newdate = mysqli_query($conn, $query);

		$amt_sql= mysqli_query($conn, "SELECT sum(amount) as amt_total FROM payment where date_string = '".$id3."'");
