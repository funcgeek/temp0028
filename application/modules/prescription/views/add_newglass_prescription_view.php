    ...
    <div class="">
            ...
            <div class="column" style="flex: 100%; padding: 5px;">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td><b>R</b></td>
                            <td><input type="text" class="form-control" name="old_rx_r_sphere" placeholder="Sphere"></td>
                            <td><input type="text" class="form-control" name="old_rx_r_cylinder" placeholder="Cylinder"></td>
                            <td><input type="text" class="form-control" name="old_rx_r_axis" placeholder="Axis"></td>
                        </tr>
                        <tr>
                            <td><b>L</b></td>
                            <td><input type="text" class="form-control" name="old_rx_l_sphere" placeholder="Sphere"></td>
                            <td><input type="text" class="form-control" name="old_rx_l_cylinder" placeholder="Cylinder"></td>
                            <td><input type="text" class="form-control" name="old_rx_l_axis" placeholder="Axis"></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td><b>R</b></td>
                            <td><input type="text" class="form-control" name="new_rx_r_sphere" placeholder="Sphere"></td>
                            <td><input type="text" class="form-control" name="new_rx_r_cylinder" placeholder="Cylinder"></td>
                            <td><input type="text" class="form-control" name="new_rx_r_axis" placeholder="Axis"></td>
                            <td><input type="text" class="form-control" name="new_rx_r_prism" placeholder="Prism"></td>
                            <td><input type="text" class="form-control" name="new_rx_r_add" placeholder="ADD"></td>
                            <td><input type="text" class="form-control" name="new_rx_r_seght" placeholder="Seg HT"></td>
                            <td><input type="text" class="form-control" name="new_rx_r_pd" placeholder="PD"></td>
                        </tr>
                        <tr>
                            <td><b>L</b></td>
                            <td><input type="text" class="form-control" name="new_rx_l_sphere" placeholder="Sphere"></td>
                            <td><input type="text" class="form-control" name="new_rx_l_cylinder" placeholder="Cylinder"></td>
                            <td><input type="text" class="form-control" name="new_rx_l_axis" placeholder="Axis"></td>
                            <td><input type="text" class="form-control" name="new_rx_l_prism" placeholder="Prism"></td>
                            <td><input type="text" class="form-control" name="new_rx_l_add" placeholder="ADD"></td>
                            <td><input type="text" class="form-control" name="new_rx_l_seght" placeholder="Seg HT"></td>
                            <td><input type="text" class="form-control" name="new_rx_l_pd" placeholder="PD"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row">
            <div class="column">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>Clear</td>
                            <td><input type="text" class="form-control" name="rec_clear"></td>
                        </tr>
                        <tr>
                            <td>Transition</td>
                            <td><input type="text" class="form-control" name="rec_transition"></td>
                        </tr>
                        <tr>
                            <td>ARC</td>
                            <td><input type="text" class="form-control" name="rec_arc"></td>
                        </tr>
                        <tr>
                            <td>Blue Filter</td>
                            <td><input type="text" class="form-control" name="rec_blue_filter"></td>
                        </tr>
                        <tr>
                            <td>Tint</td>
                            <td><input type="text" class="form-control" name="rec_tint"></td>
                        </tr>
                        <tr>
                            <td>Other</td>
                            <td><input type="text" class="form-control" name="rec_other"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="column">
                <table class="table table-bordered">
                    <thead>
                        <tr><th colspan="2">Lens type</th></tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>Single Version</td>
                            <td><input type="text" class="form-control" name="lens_single_version"></td>
                        </tr>
                        <tr>
                            <td>Bifocal</td>
                            <td><input type="text" class="form-control" name="lens_bifocal"></td>
                        </tr>
                        <tr>
                            <td>Progressive</td>
                            <td><input type="text" class="form-control" name="lens_progressive"></td>
                        </tr>
                        <tr>
                            <td>Other</td>
                            <td><input type="text" class="form-control" name="lens_other"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
