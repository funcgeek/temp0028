        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <div class=" col-md-4 pull-right">
                    <div class="pull-right custom_buttons">
					<a data-toggle="modal" href="#modalRequest">
                        <div class="btn-group pull-right">
                            <button class="btn btn-info btn-xs" style="background-color:orange;">
                                 <i class="fa fa-calendar"></i> <?php echo "Add Request";//lang('add_new'); ?>
                            </button>
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    ?>
												...
												<td>
                                                    <?php
                                                    $patient1 = $this->patient_model->getPatientById($appointment->patient);
                                                    if (!empty($patient1)) {
                                                        $patient_first_name = $patient1->first_name;
												...
												<td>
                                                    <?php
                                                    $patient2 = $this->patient_model->getPatientById($appointment->patient);
                                                    if (!empty($patient2)) {
                                                        $patient_last_name = $patient2->last_name;
														$patid = $appointment->patient;
                                                    } else {
                                                        $patient_last_name = '';
                                                    }
...
<!-- Add Appointment Modal-->
                                ...
                                <div class="modal" role="dialog" id="modalRequest">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">

                                            <div class="modal-body">

                                                <form action="frontend/addNewRequest" method="post">
                        <label for="exampleInputEmail1"> <?php echo lang('patient'); ?></label> 
                        <select class="form-control m-bot15 js-example-basic-single pos_select" id="pos_select" name="patient" value=''> 
                            <option value="">Select</option>
                            <option value="add_new" style="color: #41cac0 !important;"><?php echo lang('add_new'); ?></option>
