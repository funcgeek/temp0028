                ...
                <form role="form" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="pos_client clearfix">
                        <div class="col-md-8 payment pad_bot pull-right">
                            ...
                            <div class="col-md-3 payment_label"> 
                                <label for="exampleInputEmail1"> <?php echo 'Alias or';//lang('patient'); ?> <?php echo 'Company';//lang('alias_company'); ?></label>
                            </div>
                            <div class="col-md-9"> 
						...
						<div class="col-md-8 payment pad_bot pull-right">
                            <div class="col-md-3 payment_label"> 
                                <label for="firstname"> <?php echo lang('patient'); ?> <?php echo lang('first_name'); ?></label>
                            </div>
                            <div class="col-md-9"> 
                                <input type="text" class="form-control pay_in" name="pf_name" value='<?php
                                if (!empty($payment->pf_name)) {
                                    echo $payment->pf_name;
                                }
                                ?>' placeholder="">
                            </div>
                        </div>   
						<div class="col-md-8 payment pad_bot pull-right">
                            <div class="col-md-3 payment_label"> 
                                <label for="middlename"> <?php echo lang('patient'); ?> <?php echo lang('middle_name'); ?></label>
                            </div>
                            <div class="col-md-9"> 
                                <input type="text" class="form-control pay_in" name="pm_name" value='<?php
                                if (!empty($payment->pm_name)) {
                                    echo $payment->pm_name;
                                }
                                ?>' placeholder="">
                            </div>
                        </div>  						
						<div class="col-md-8 payment pad_bot pull-right">
                            <div class="col-md-3 payment_label"> 
                                <label for="lastname"> <?php echo lang('patient'); ?> <?php echo lang('last_name'); ?></label>
                            </div>
                            <div class="col-md-9"> 
                                <input type="text" class="form-control pay_in" name="pl_name" value='<?php
                                if (!empty($payment->pl_name)) {
                                    echo $payment->pl_name;
                                }
                                ?>' placeholder="">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 panel">
                        ...
                        <div class="col-md-9"> 
                            <select class="form-control" name="remarks" id="exampleInputEmail1" >
                        ...
                        <div class="col-md-9"> 
                            <select class="form-control m-bot15" name="status" value=''>
                                ...
                                if (!empty($appointment->status)) {
                                    if ($appointment->status == lang('pending_confirmation')) {
                                        echo 'selected';
                                    }
                                }
                                ...
                                if (!empty($appointment->status)) {
                                    if ($appointment->status == lang('confirmed')) {
                                        echo 'selected';
                                    }
                                }
                                ...
                                if (!empty($appointment->status)) {
                                    if ($appointment->status == lang('treated')) {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo lang('treated'); ?> </option>
                                <option value="Dilating" <?php
                                if (!empty($appointment->status)) {
                                    if ($appointment->status == 'Dilating')) {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'Dilating'; ?> </option> 
								<option value="<?php echo lang('cancelled'); ?>" <?php
                                if (!empty($appointment->status)) {
                                    if ($appointment->status == lang('cancelled')) {
                                        echo 'selected';
                                    }
                                }
