                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th> <?php echo 'Alias|Company';//lang('patient'); ?></th>
                                <th> <?php echo 'Firstname';//lang('patient'); ?></th>
                                <th> <?php echo 'Lastname';//lang('patient'); ?></th>
                                <th> <?php echo lang('doctor'); ?></th>
                                <th> <?php echo lang('date-time'); ?></th>
                                <th> <?php echo lang('remarks'); ?></th>
                                <th> <?php echo 'Comments';//lang('remarks'); ?></th>
                        ...
                        foreach ($appointments as $appointment) {
                            if ($appointment->date == strtotime(date('Y-m-d'))) {
                                ...
                                <tr class="">
									...
									<td> <?php echo $this->db->get_where('patient', array('id' => $appointment->patient))->row()->first_name; ?></td>
									<td> <?php echo $this->db->get_where('patient', array('id' => $appointment->patient))->row()->last_name; ?></td>
                                    <td><?php
                                    ...
                                    <td>
                                      ...
                                      <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $appointment->id; ?>"><i class="fa fa-edit"> <?php echo lang('edit'); ?></i></button>  
										...
										<a class="btn green" title="<?php echo lang('history'); ?>" href="patient/medicalHistory?id=<?php echo $appointment->patient; ?>"><i class="fa fa-stethoscope"></i> <?php echo lang('history'); ?></a>	
										
										<?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>										
										<span data-placement="bottom" data-toggle="popover0" data-container="body" data-placement="top" type="button" data-html="true" href="#" id="login" class="btn btn-default" ><?php echo lang('update_status'); ?></span>
										
										    <div id="popover-content0" class="hide">
												<div class="row ">
																							

													<div class="col-lg-12"><a href="#" class="close" data-dismiss="alert">&times;</a>
															<h4><small>Update Registration Status</small></h4>
															<form action="update-appointment-status.php" method="post" id="admin_upstatus" >
															
																<input type='hidden' value="<?php echo $appointment->id; ?>" name="admin_status" />
														
																<input type='submit' class="but" name='seen' value='Treated' />
																<input type='submit' class="but" name='not_seen' value='Pending Confirmation' />
																<input type='submit' class="but" name='vitals_taken' value='Confirmed' />
										...
										<span data-placement="bottom" data-toggle="popover1" data-container="body" data-placement="top" type="button" data-html="true" href="#" id="login" class="btn btn-default" ><?php echo lang('update_status'); ?></span>
										...
										<span data-placement="bottom" data-toggle="popover2" data-container="body" data-placement="top" type="button" data-html="true" href="#" id="login" class="btn btn-default" ><?php echo lang('update_status'); ?></span>
										    ...
										    <div id="popover-content2" class="hide">
												<div class="row ">
													...
													<div class="col-lg-12"><a href="#" class="close" data-dismiss="alert">&times;</a>
															<h4><small>Update Registration Status</small></h4>
															<form action="update-appointment-status.php" 
															
															method="post" id="admin_upstatus" >
            ...
            <div class="modal-body row">
                <form role="form" action="appointment/addNew" method="post" class="clearfix" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 panel">
                        ...
                        <input type="text" class="form-control default-date-picker" id="date" readonly="" name="date" id="exampleInputEmail1" value='<?php echo date('d-m-Y');?>' placeholder="">
                    </div>
                    <div class="col-md-6 panel">
                    ...
                    <div class="col-md-6 panel">
                        ...
                        <select class="form-control m-bot15" name="status" value=''>
                            <option value="<?php echo lang('pending_confirmation'); ?>" <?php
                            ?> > <?php echo lang('pending_confirmation'); ?> </option>
                            <option value="<?php echo lang('confirmed'); ?>" <?php
                            ?> > <?php echo lang('confirmed'); ?> </option>
                            <option value="<?php echo lang('treated'); ?> " <?php
                            ?> > <?php echo lang('treated'); ?> </option>
							<option value="Dilating" <?php ?> > <?php echo 'Dilating'; ?> </option> 
                                <option value="Other" <?php ?> > <?php echo 'Other'; ?> </option> 
                            <option value="<?php echo lang('cancelled'); ?>" <?php
					...
					<div class="col-md-6 panel">
                        ...
                        <input type="text" class="form-control" id="exampleInputComments" name="comments" value='' placeholder="">
                    </div>
                 <!--   <div class="col-md-6 panel">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editAppointmentForm" action="appointment/addNew" class="clearfix" method="post" enctype="multipart/form-data">
					...
					<div class="col-md-6 panel">
                        <label for="exampleInputComments"> <?php echo lang('comments'); ?></label>
                        <input type="text" class="form-control" name="comments" id="exampleInputComments" value='' placeholder="">
                    </div>
                    <div class="col-md-6 panel">
                     <!--   <label> <?php echo lang('send_sms'); ?> ? </label> <br>
                        <input type="checkbox" name="sms" class="" value="sms">  <?php echo lang('yes'); ?> -->
