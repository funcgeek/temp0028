                    ...
                    <div class="col-md-6 panel">
                        ...
                        <select class="form-control m-bot15 js-example-basic-single pos_select" id="pos_select" name="patient" value=''> 
                            ...
                            <?php foreach ($patients as $patient) { ?>
                                ...
                                ?> ><?php echo $patient->name.'&nbsp;|&nbsp;'.$patient->first_name.'&nbsp;|&nbsp;'.$patient->last_name; ?> </option>
                                    <?php } ?>
                        </select>
                    </div>
...
.flex-item:nth-of-type(6) { order: 6; }
 ...
 <div class="flex-container2">
						...
						<div  class="flex-item payment pad_bot pull-right" >
						...
						<div class="flex-item payment pad_bot pull-right"  >
                            <label for="alias"> <?php echo lang('patient'); ?> <?php echo 'Alias';//lang('name'); ?></label> 
