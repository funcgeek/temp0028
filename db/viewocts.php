		...
		<div class="container">
			<div class="row">
				<div class="col-12 mt-5 text-center">
					<h1>All OCT for this patient.</h1>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-12 mt-5">
					...
					//	$working_dir = getcwd();
						...
						//get image directory
						$img_dir = "../uploads/patient/oct/$id/";
					...
					//	chdir($working_dir);
						...
						?>
							<div class="gallery-item">
								<a href="<?php echo "../uploads/patient/oct/".$id."/" . $file ?>" data-lightbox="gallery">
									<img src="<?php echo "../uploads/patient/oct/".$id."/" . $file ?>" width="500" height="700"/>
								</a>
							</div>
						<?php }
					?>
