...
<html lang="en">
	...
	?>
		<!-- Required meta tags -->
		<title>All Patient Sick Leaves</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-12 mt-5 text-center">
					<h1>All Sick Leaves for this patient.</h1>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-12 mt-5">
					...
					//	$working_dir = getcwd();
						...
						//get image directory
						$img_dir = "../uploads/patient/sickleave/".$id."/";
					...
					//	chdir($working_dir);
						...
						?>
							<div class="gallery-item">
								<a href="<?php echo "../uploads/patient/sickleave/".$id."/" . $file ?>" data-lightbox="gallery">
									<img src="<?php echo "../uploads/patient/sickleave/".$id."/" . $file ?>" width="500" height="700"/>
								</a>
							</div>
						<?php }
					?>
