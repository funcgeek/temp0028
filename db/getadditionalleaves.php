...
if($row['multi_image'] ==='yes'){
		$locate2 = "http://localhost/uploads/patient/documents/".$row['patient_id']."/";
...
&nbsp;&nbsp;&nbsp;
   <span class="action"><a href="./db/deleteimages.php?id2=<?php echo $row['id'];?>" class="btn btn-danger btn-sm" title="Delete"><i class="fa fa-trash"></i> </a></span>   
...
<div class="gallery">
  ...
  <div class="desc"><font size="1"><?php echo basename($row['image_url']); ?><br>(<b><?php echo $row['title']; ?></b>)</font></div>
	<a class="btn btn-primary" href="<?php echo $locate2.'/'.$row['image_name']; ?>" download> Download</a>
&nbsp;&nbsp;&nbsp;
   <span class="action"><a href="http://localhost/db/deleteimages.php?id2=<?php echo $row['id'];?>" class="btn btn-danger btn-sm" title="Delete">Delete </a></span>   
