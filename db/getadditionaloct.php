...
$query = "SELECT * FROM patient_oct as pm, patient_oct_images as pmi WHERE pm.patient = pmi.patient_id 
AND pmi.image_id =".$id;
...
if($row['multi_image'] ==='yes'){
		$locate2 = "./uploads/patient/oct/".$row['patient_id']."/";
...
&nbsp;&nbsp;&nbsp;
   <span class="action"><a href="./db/deleteoct.php?id2=<?php echo $row['id'];?>" class="btn btn-danger btn-sm" title="Delete"><i class="fa fa-trash"></i> </a></span>   
